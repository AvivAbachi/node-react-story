...
const _FaceIcon = memo(function FaceIcon() {
	return (
...
const _MenuIcon = memo(function MenuIcon() {
	return (
...
const _PlusIcon = memo(function PlusIcon() {
	return (
...
const _CloseIcon = memo(function CloseIcon() {
	return (
...
const _ErrorIcon = memo(function ErrorIcon() {
	return (
...
const _TrashIcon = memo(function TrashIcon() {
	return (
...
const _EditIcon = memo(function EditIcon() {
	return (
		<svg className='edit-icon' viewBox='0 0 576 512' height='1em' width='1em' xmlns='http://www.w3.org/2000/svg'>
